    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg mb-8">
          Access your personal dashboard to track your progress, view your reading history,
          and receive recommendations tailored to your specific needs.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-8">
          ...
          <div className="bg-primary/5 p-4 rounded-lg flex flex-col items-center">
            ...
            <p className="text-center">Get advice adapted to your specific needs and interests</p>
          </div>
        </div>
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Note: For demonstration purposes, simply click the button to simulate a login.
          In a final version, a complete authentication system would be implemented.
        </p>
      </div>
    </div>
  );
